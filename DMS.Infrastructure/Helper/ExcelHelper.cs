...
public static class ExcelHelper
{
    ...
    public static List<DMS.Core.Models.Variable> ImprotFromTiaVariableTable(string excelFilePath)
    {
        // Act
        ...
        List<DMS.Core.Models.Variable> variableDatas = new List<DMS.Core.Models.Variable>();
